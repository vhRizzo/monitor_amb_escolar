...
class DSM501a2_5SensorStore {
public:
  void setup(GPIOPin *pin) {
    pin->setup();
    this->pin_ = pin->to_isr();
    this->last_fall_ = micros();
    pin->attach_interrupt(&DSM501a2_5SensorStore::gpio_intr, this, CHANGE);
  }
...
public:
  DSM501a2_5Sensor() : PollingComponent (5000) {}
...
void DSM501a2_5Sensor::dump_config() {
  LOG_SENSOR("", "DSM501a 2.5 um", this)
